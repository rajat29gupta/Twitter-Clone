  ...
  <div id="app" class="flex container h-screen w-full">
    ...
    <div class="lg:w-1/5 border-r border-lighter lpx-2 lg:px-6 py-2 flex flex-col justify-between">
      <div>
        ...
        <div>
          ...
          >
            ...
            <p class="fas fa-plus lg:hidden"></p>
          </button>
        </div>
      </div>
      <div class="lg:w-full relative">
        ...
        >
          <img src="profile.jpg" alt="profile" class="w-12 h-12 rounded-full border border-lighter" />
          <div class="hidden lg:block ml-4">
            <p class="text-sm font-bold leading-tight">Rajat Gupta</p>
            <p class="text-sm leading-tight">@rajat29gupta</p>
          </div>
      ...
      <div class="px-5 py-3 border-b-8 border-lighter flex">
        <div class="flex-none">
          <img
            src="profile.jpg"
            alt="profile"
            class="fle-none w-12 h-12 rounded-full border border-lighter"
          />
        </div>
        ...
        >
          ...
          <div class="w-full">
            <div class="flex items-center w-full">
              <p class="font-semibold">Rajat Gupta</p>
              <p class="text-sm text-dark ml-2">@rajat29gupta</p>
